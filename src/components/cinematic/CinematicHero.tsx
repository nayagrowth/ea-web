  ...
  return (
    <div ref={containerRef} className="relative w-full bg-[#08090a]">
      ...
      >
        ...
        {/* Layer z-6: Live Animatable Vector Environment (Wall Ribs, Tarmac Floor, Speed Rails, Laser Horizon) */}
        ...
        {/* Layer z-20: Act 2 Canonical 1672x941 Live Animatable 3D Typography Poster */}
        <Act2VelocityPoster />
