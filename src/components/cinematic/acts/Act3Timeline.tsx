...
export const Act3Timeline: React.FC = () => {
  return (
    <div className="act3-stage absolute inset-0 z-20 w-full h-full flex flex-col justify-center items-start px-6 sm:px-12 lg:px-20 2xl:px-28 pointer-events-none select-none">
      <div className="act3-typo-block flex flex-col max-w-5xl text-left">
        {/* Line 1: WITHIN YOUR (Strictly 1 line, uppercase bold) */}
        <h2 className="whitespace-nowrap text-[clamp(3.5rem,8.5vw,8.5rem)] font-black text-white tracking-[-0.04em] leading-[0.94] uppercase drop-shadow-[0_12px_60px_rgba(0,0,0,0.98)]">
          Within your
        </h2>

        {/* Line 2: planned timeline. (Strictly 1 line, glowing gold serif italic) */}
        <h2 className="whitespace-nowrap text-[clamp(3.8rem,9.5vw,9.5rem)] font-black tracking-[-0.045em] leading-[0.94] mt-2 sm:mt-3 drop-shadow-[0_14px_70px_rgba(0,0,0,0.98)]">
