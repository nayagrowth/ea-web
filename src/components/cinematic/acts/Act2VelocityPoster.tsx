...
export const Act2VelocityPoster: React.FC = () => {
  return (
    <div className="act2-velocity-stage act2-stage absolute inset-0 z-20 w-full h-full pointer-events-none select-none overflow-hidden">
      {/* ===================================================================== */}
      {/* CANONICAL 1672 x 941 3D ARTBOARD CONTAINER (Exact Reference Match)   */}
      {/* ===================================================================== */}
      <div className="act2-artboard-container absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
        <div
          ...
          style={{
            ...
            perspective: '1350px',
            perspectiveOrigin: '85.3% 62.5%', // Camera anchored to right architectural wall vanishing corridor
        ...
        >
          ...
          {/* Layer z-20: DOM 3D Typography Plane (True Spatial Foreshortening) */}
          <div
            className="act2-type-plane absolute inset-0 pointer-events-none select-none z-20"
            style={{ transformStyle: 'preserve-3d' }}
          >
            {/* ----------------------------------------------------------------- */}
            {/* ROW 1: "We" (Heavy Sans) + "sell-out" (Champagne Italic Serif)     */}
            {/* ----------------------------------------------------------------- */}
            {/* "We" */}
            <span
              className="
